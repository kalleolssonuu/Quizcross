<template>
    ...
    <div class="buttonWrapper">
        ...
        <div id="buttonArea">
            ...
            <input v-if="this.lang == 'en'" type="text" v-model="gameID" id="gameName" name="gameName"
                placeholder="  Enter game name...">
            <input v-else type="text" v-model="gameID" id="gameName" name="gameName" placeholder=" Namnge korsordet...">

            <button v-if="this.gameID == ''" class="standardButtonPreCreate disabled" disabled id="confirmAndCreate">{{
                uiLabels.confirmAndCreate
            }}</button>
            <button v-else class="standardButtonPreCreate" id="confirmAndCreate" v-on:click="checkIfNameExist">{{
                uiLabels.confirmAndCreate
            }}</button>
        </div>
    </div>
